...
<html lang="en">
  <head>
    ...
    <meta name="description" content="BitShares uses an advanced referral programme, built directly into its software, to reward those who refer new users">
    ...
    <meta property="og:description" content="BitShares uses an advanced referral programme, built directly into its software, to reward those who refer new users">
...
<br />
    <h2 id="background---paypals-referral-system">Background - PayPal’s Referral System</h2>
         <p>Bootstrapping a new financial network is very hard, and often becomes a chicken-and-egg problem. It is difficult to attract new users, because new users will only join if other users are already members.</p>
         <p>To overcome this problem, we looked at how companies like <a href="https://paypal.com" target="_blank">PayPal</a> reached critical mass.</p>
<blockquote>
...
<br />
    ...
    <center><img class="img-responsive img-thumbnail" src="../assets/images/wellbalanced.svg"/ alt=""></center>
