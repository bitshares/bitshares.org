...
function gauge($x){
global $gauge_return;
if ($x == "x"){$gauge_return = '<td class="line_cell"><img class="inline icon2"  src="design/gauge/gauge_no_data.png" alt="gauge"><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">(no data)</span></div></td>';}	
else{
if ($x < 1){$gauge_return = '<td class="line_cell"><div class="gauge01"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 1 AND $x < 10){$gauge_return = '<td class="line_cell"><div class="gauge02"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 10 AND $x < 25){$gauge_return = '<td class="line_cell"><div class="gauge03"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 25 AND $x < 33){$gauge_return = '<td class="line_cell"><div class="gauge04"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 33 AND $x < 41){$gauge_return = '<td class="line_cell"><div class="gauge05"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 41 AND $x < 50){$gauge_return = '<td class="line_cell"><div class="gauge06"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 50 AND $x < 58){$gauge_return = '<td class="line_cell"><div class="gauge07"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 58 AND $x < 66){$gauge_return = '<td class="line_cell"><div class="gauge08"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 66 AND $x < 75){$gauge_return = '<td class="line_cell"><div class="gauge09"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 75 AND $x < 84){$gauge_return = '<td class="line_cell"><div class="gauge10"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 84 AND $x < 94){$gauge_return = '<td class="line_cell"><div class="gauge11"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
if ($x >= 94 AND $x <= 100){$gauge_return = '<td class="line_cell"><div class="gauge12"></div><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext">'.$x.'<span class="exposant">%</span></span></div></td>';}	
}
return $gauge_return;
}
// **********************************************   </FONCTIONS>   **********************************************************
...
if($symbol[$act] == "BTC")
{
	if($unconfirmed_btc > 7500){
		$prepa_gauge = '<td class="line_cell"><img class="inline icon2"  src="design/gauge/gauge_ut.png" alt="gauge_ut"><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext"> 100% blockchain capacity + '.number_format($unconfirmed_btc).' Unconfirmed Transactions</span></div></td>';;
		}
...
elseif($symbol[$act] == "ETH")
{
	if($unconfirmed_eth > 7500){
		$prepa_gauge = '<td class="line_cell"><img class="inline icon2"  src="design/gauge/gauge_ut.png" alt="gauge_ut"><div class="tooltip"><span class="exposant">&#9432;</span><span class="tooltiptext"> 100% blockchain capacity + '.number_format($unconfirmed_eth).' Unconfirmed Transactions</span></div></td>';;
		}
	else{$prepa_gauge = gauge($index_cui[$act]);}
}
...
$table_text .= '<td class="line_cell line_1_cell"><div class="'.$symbol[$act].'"></div></td>';
$table_text .= '<td class="line_cell text_align_left bold"><a href="javascript:void(0);">'.$symbol[$act].' </a><div class="tooltip"><span class="exposant_symbol">&#9432;</span><span class="tooltiptext">'.$name_c[$act].'</span></div></td>';
$table_text .= '<td class="line_cell bold pl-8">'.number_format($tx[$act]).'<span class="exposant w3-text-blue-grey">Op </span></td>';
...
$table_text .= '<td class="line_cell bold pl-8"><span class="exposant w3-text-blue-grey">$ </span>'.$market_cap_usd[$act].'<span class="w3-text-blue-grey"> B</span></td>';
$table_text .= '<td class="line_cell pl-8">'.$index_avi[$act].'</td>';
