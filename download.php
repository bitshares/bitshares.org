...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Download section for BitShares 2.0">
    <meta name="keywords" content="bitshares, blockchain, wallet, download, access, windows, win, mac, osx, linux, cli, core, ui">
    <title>Download | BitShares Blockchain</title>
	<base href="/">
    ...
    <!--  Open Graph Tags -->
    <meta property="og:title" content="Download | BitShares Blockchain">
    <meta property="og:description" content="Download section for BitShares 2.0">
 ...
 <body>
    ...
    <main class="main-content">
      <section class="section section-x">
        <div class="container">
			<br />
			<h4>BitShares 2.0 (GUI January 08, 2019 / Core March 26, 2019)</h4>
...
<!--				<li class="mt-25">
			...
			<ul class="ml-30">
			<li>OS: Windows 7+ or Mac OSX 10.8+</li>
			<li>Browser: Google Chrome, Mozila Firefox or Opera (Modern Internet Browser)</li>
			</ul>
			<br />
			</ul>
